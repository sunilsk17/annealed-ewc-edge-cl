...
Evaluates a trained model on all 10 tasks of Split-CIFAR-100.
"""
...
def evaluate_cifar100(checkpoint_path, output_file='cifar100_results.json'):
    """
    Evaluate model on all CIFAR-100 tasks.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='cifar100_results.json',
                       help='Output JSON file')
    args = parser.parse_args()
    
    evaluate_cifar100(args.checkpoint, args.output)
